...
-- opt.pause = 2, opt.readFCN = 1 means read FCN and randomly initialized GAN parameters
-- opt.pause = 1, opt.readFCN = 0 means reading trained networks generated by this scripts 
-- opt.pause = 0, opt.readFCN = 0 means reading previous trained condition GAN and FCN 
